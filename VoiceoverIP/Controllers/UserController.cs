...
using AutoMapper;
using VoiceoverIP.UserService;
using Subscription = VoiceoverIP.Models.Subscription;
using User = VoiceoverIP.Services.Model.User;



namespace VoiceoverIP.Controllers
{
    public class UsersController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            {
                var result = client.GetList().Select(x => new Models.User
                {
                    Id = x.Id,
        ...
        [HttpPost]
        public HttpResponseMessage Post([FromBody]Models.UserSubmission user)
        {
        ...
        public HttpResponseMessage Put([FromBody]Models.UserSubscription userSubscription)
        {
